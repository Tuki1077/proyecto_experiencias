...
-   [npm run dev] Ejecuta el servidor para poder trabajar, http://https://bf8t0s9gnh.execute-api.us-east-1.amazonaws.com:PORT con el fin de que cors funcione correctamente recomendamos el puerto: 8080
...
-   [yarn start] Ejecuta el servidor para poder trabajar, http://https://bf8t0s9gnh.execute-api.us-east-1.amazonaws.com:PORT con el fin de que cors funcione correctamente recomendamos el puerto: 3000
